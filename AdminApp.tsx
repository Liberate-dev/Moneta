      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-200">
          ...
          <div className="space-y-5">
            ...
            <div className="pt-6">
              <PrimaryButton onClick={handleGenerate} fullWidth className="py-4 text-lg shadow-sky-500/20">
                Generate QR Code
              </PrimaryButton>
            </div>
          </div>
            ...
            <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(#ffffff 1px, transparent 1px)', backgroundSize: '24px 24px' }}></div>
             ...
             {!generatedQR ? (
               ...
               <div className="w-full animate-in zoom-in duration-300 relative z-10 flex flex-col items-center">
                  ...
                  <PrimaryButton onClick={handlePrint} variant="secondary" className="bg-white hover:bg-slate-200 text-slate-900 border-none font-bold">
