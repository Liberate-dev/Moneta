...
export const AppButton: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: "bg-sky-500 hover:bg-sky-600 text-white shadow-lg shadow-sky-500/30 border-none",
    secondary: "bg-white text-slate-800 border border-slate-300 hover:bg-slate-50",
    danger: "bg-red-500 hover:bg-red-600 text-white shadow-lg shadow-red-500/30 border-none",
